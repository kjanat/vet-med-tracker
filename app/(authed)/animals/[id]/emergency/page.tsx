    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print p-4 border-b">
        <div className="flex items-center justify-between max-w-4xl mx-auto">
          <h1 className="text-2xl font-bold">Emergency Card - {mockAnimal.name}</h1>
      ...
      <div className="max-w-4xl mx-auto p-8 print:p-4">
        <div className="border-2 border-red-500 rounded-lg p-6 print:border-black">
          ...
          <div className="text-center mb-6">
            <h1 className="text-3xl font-bold text-red-600 print:text-black mb-2">EMERGENCY CARD</h1>
            <p className="text-lg text-muted-foreground">Keep this information accessible at all times</p>
          </div>
          ...
          <Card className="mb-6">
            ...
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                ...
                <div>
                  <span className="font-medium">Weight:</span> {mockAnimal.weightKg}kg
                </div>
                <div>
                  <span className="font-medium">Age:</span>{" "}
                  {Math.floor((Date.now() - mockAnimal.dob.getTime()) / (365.25 * 24 * 60 * 60 * 1000))} years
                </div>
                <div>
                ...
                {mockAnimal.microchipId && (
                  <div className="md:col-span-2">
                    <span className="font-medium">Microchip:</span> {mockAnimal.microchipId}
                  </div>
                )}
              </div>
            </CardContent>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="p-4 border rounded-lg">
                  <div className="font-medium text-lg">Primary Veterinarian</div>
          ...
          {/* Medical Alerts */}
          {(mockAnimal.allergies.length > 0 || mockAnimal.conditions.length > 0) && (
            <Card className="mb-6 border-red-200 bg-red-50 print:bg-gray-100">
              ...
              <CardContent>
                {mockAnimal.allergies.length > 0 && (
                  <div className="mb-4">
                    <div className="font-medium text-red-700 print:text-black mb-2">ALLERGIES:</div>
                ...
                {mockAnimal.conditions.length > 0 && (
                  <div>
                    <div className="font-medium text-red-700 print:text-black mb-2">CONDITIONS:</div>
                    <div className="flex flex-wrap gap-2">
          ...
          <div className="text-center text-sm text-muted-foreground border-t pt-4">
            <p>Generated on {new Date().toLocaleDateString()} • Keep this card updated</p>
            <p className="mt-2">In case of emergency, contact your veterinarian immediately</p>
          </div>
        </div>
      </div>
