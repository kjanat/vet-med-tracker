...
import { useFormErrorHandler } from "@/hooks/shared/useErrorHandler";
...
/**
 * Base form return type combining state and actions
 */
export interface BaseFormReturn<TFormData extends FieldValues>
  extends BaseFormState,
    BaseFormActions<TFormData> {
 ...
 * Eliminates duplication between useAnimalForm, useInventoryForm, etc.
 *
 * @example
 * const useAnimalForm = createFormHook({
 *   resolver: zodResolver(animalFormSchema),
 *   dataTransformer: AnimalDataTransformer,
 *   validator: AnimalFormValidator,
 *   mutation: { useMutation: () => trpc.animals.create.useMutation() },
 *   formState: { useFormState: useAnimalFormState },
 *   resourceName: "animal"
 * });
 */
