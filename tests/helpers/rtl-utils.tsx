...
const MockAppProvider: React.FC<MockAppProviderProps> = ({ 
  ...
  const contextValue = {
    household: household || { id: testConfig.mockSession.access.householdId, name: "Test Household" },
  ...
  return (
    <div data-testid="mock-app-provider" data-context={JSON.stringify(contextValue)}>
      {children}
    </div>
  );
};
  ...
  const AllProviders: React.FC<{ children: React.ReactNode }> = ({ children }) => (
    <QueryClientProvider client={queryClient}>
      <TRPCProvider client={trpcClient} queryClient={queryClient}>
        <MockThemeProvider>
          <MockAppProvider household={household} selectedAnimal={selectedAnimal}>
            {children}
          </MockAppProvider>
        </MockThemeProvider>
      </TRPCProvider>
...
export const expectMatchesSnapshot = (component: ReactElement, snapshotName?: string) => {
