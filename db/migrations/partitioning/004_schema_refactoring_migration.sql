...
CREATE TABLE vetmed_user_profiles (
    ...
    profile_visibility jsonb DEFAULT '{"name": true, "email": false, "bio": true, "location": true}'::jsonb,
...
ANALYZE vetmed_households;
ANALYZE vetmed_users;
ANALYZE vetmed_user_profiles;
ANALYZE vetmed_user_preferences;
ANALYZE vetmed_emergency_contacts;
ANALYZE vetmed_memberships;
ANALYZE vetmed_veterinarians;
ANALYZE vetmed_animals;
ANALYZE vetmed_animal_veterinarians;
ANALYZE vetmed_animal_medical_records;
ANALYZE vetmed_animal_allergies;
ANALYZE vetmed_medications;
ANALYZE vetmed_dosage_guidelines;
ANALYZE vetmed_species_adjustments;
ANALYZE vetmed_breed_considerations;
ANALYZE vetmed_route_adjustments;
ANALYZE vetmed_inventory_items;
ANALYZE vetmed_regimens;
ANALYZE vetmed_administrations;
ANALYZE vetmed_notifications;
ANALYZE vetmed_audit_log;
ANALYZE vetmed_suggestions;
ANALYZE vetmed_cosign_requests;
ANALYZE vetmed_push_subscriptions;
...
INSERT INTO vetmed_audit_log (
    user_id, household_id, action, resource_type, 
    details, timestamp
) VALUES (
...
COMMENT ON SCHEMA public IS 'VetMed Tracker - Refactored schema with proper normalization and performance optimizations. Migration 004 completed successfully.';
