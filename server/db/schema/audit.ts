...
export const auditLog = pgTable('vetmed_audit_log', {
...
export const notificationQueue = pgTable('vetmed_notification_queue', {
  id: uuid('id').defaultRandom().primaryKey(),
  ...
  scheduledForIdx: index('notification_scheduled_for_idx').on(table.scheduledFor),
