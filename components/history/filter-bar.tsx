      ...
      <div className="flex flex-wrap items-center gap-4">
        ...
        <div className="flex rounded-lg border p-1">
          <Button
            ...
            onClick={() => {
              setFilter("view", "list")
              window.dispatchEvent(new CustomEvent("history_view_toggle", { detail: { view: "list" } }))
            }}
          >
            List
          </Button>
          <Button
            ...
            onClick={() => {
              ...
              window.dispatchEvent(new CustomEvent("history_view_toggle", { detail: { view: "calendar" } }))
            }}
          >
            Calendar
          </Button>
        ...
        <Select
          ...
          onValueChange={(value) => setFilter("animalId", value === "all" ? undefined : value)}
        >
      ...
      <PopoverContent className="w-auto p-0" align="start">
        <div className="p-4 space-y-4">
          <div className="space-y-2">
            <Label>From</Label>
            <CalendarComponent mode="single" selected={from} onSelect={(date) => onSelect(date, to)} initialFocus />
          </div>
          <div className="space-y-2">
            <Label>To</Label>
            <CalendarComponent mode="single" selected={to} onSelect={(date) => onSelect(from, date)} />
          </div>
        </div>
      </PopoverContent>
    </Popover>
