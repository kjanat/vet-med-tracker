...
import { Lightbulb, Clock, ArrowRight, Shield, Check, Undo2 } from "lucide-react"
...
const mockSuggestions: Suggestion[] = [
  ...
  },
  {
    ...
    rationale: "Two caregivers recorded within 10 minutes twice in the last 14 days",
    action: {
      animalId: "1",
...
const suggestionColors = {
  ADD_REMINDER: "border-blue-200 bg-blue-50",
  SHIFT_TIME: "border-orange-200 bg-orange-50",
...
export function ActionableSuggestions({ range }: ActionableSuggestionsProps) {
  ...
  const [revertTimers, setRevertTimers] = useState<Map<string, NodeJS.Timeout>>(new Map())
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 space-y-2">
                    ...
                    {isApplied ? (
                      ...
                      <Button onClick={() => handleApplySuggestion(suggestion)} size="sm" className="w-full">
                        Apply Suggestion
                      </Button>
                    )}
                  </div>
