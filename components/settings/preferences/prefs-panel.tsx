  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Customize your experience and default settings</p>
      </div>
            ...
            <div className="grid grid-cols-3 gap-3">
              <Card
                className={`cursor-pointer transition-colors ${
                  prefs.theme === "system" ? "ring-2 ring-primary" : "hover:bg-accent"
                }`}
              ...
              <Card
                className={`cursor-pointer transition-colors ${
                  prefs.theme === "light" ? "ring-2 ring-primary" : "hover:bg-accent"
                }`}
              ...
              <Card
                className={`cursor-pointer transition-colors ${
                  prefs.theme === "dark" ? "ring-2 ring-primary" : "hover:bg-accent"
                }`}
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) => setPrefs((prev) => ({ ...prev, clock12h: value === "12h" }))}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setPrefs((prev) => ({ ...prev, weekStartsOn: Number.parseInt(value) as 0 | 1 }))
                }
              >
                <SelectTrigger>
                  <SelectValue />
        ...
        <CardContent>
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              <Card
                className={`cursor-pointer transition-colors ${
                  prefs.units === "metric" ? "ring-2 ring-primary" : "hover:bg-accent"
                }`}
                onClick={() => setPrefs((prev) => ({ ...prev, units: "metric" }))}
              >
                <CardContent className="p-4 text-center">
                  <div className="font-medium">Metric</div>
                  <div className="text-sm text-muted-foreground">kg, ml, cm</div>
                </CardContent>
              </Card>

              <Card
                className={`cursor-pointer transition-colors ${
                  prefs.units === "imperial" ? "ring-2 ring-primary" : "hover:bg-accent"
                }`}
                onClick={() => setPrefs((prev) => ({ ...prev, units: "imperial" }))}
              >
                <CardContent className="p-4 text-center">
                  <div className="font-medium">Imperial</div>
                  <div className="text-sm text-muted-foreground">lbs, fl oz, in</div>
                </CardContent>
              </Card>
            </div>
          </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Set default selections for faster access</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setPrefs((prev) => ({ ...prev, defaultHouseholdId: value === "none" ? undefined : value }))
                }
              >
                <SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setPrefs((prev) => ({ ...prev, defaultAnimalId: value === "none" ? undefined : value }))
                }
              >
                <SelectTrigger>
                  <SelectValue placeholder="No default" />
