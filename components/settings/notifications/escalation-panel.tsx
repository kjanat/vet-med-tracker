    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Configure when and how often you receive medication reminders</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(value) => setPrefs((prev) => ({ ...prev, leadMinutes: Number.parseInt(value) }))}
            >
            ...
            <p className="text-sm text-muted-foreground">How early to send the first reminder</p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-2">
              <Input
                ...
                onKeyDown={(e) => e.key === "Enter" && (e.preventDefault(), addAttempt())}
                className="w-[200px]"
              />
            ...
            <p className="text-sm text-muted-foreground">
              Negative numbers send reminders before the scheduled time, positive numbers after
            </p>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Who gets notified when medications are missed</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(value) => setPrefs((prev) => ({ ...prev, escalationRole: value as "Owner" | "Lead" }))}
            >
              <SelectTrigger className="w-[200px]">
                <SelectValue />
              </SelectTrigger>
