...
export function RegimenList() {
  ...
  const handleSave = async (data: Partial<Regimen>) => {
    ...
    window.dispatchEvent(
      new CustomEvent(editingRegimen ? "settings_regimens_update" : "settings_regimens_create", {
        detail: {
    ...
    // Show success toast
    console.log(`${editingRegimen ? "Updated" : "Created"} regimen for ${data.medicationName}`)
  }
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Manage medication schedules and dosing</p>
        </div>
            ...
            <div key={animalId} className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">{regimens.length} active regimens</p>
                </div>
              </div>
      ...
      {/* Regimen Form */}
      <RegimenForm regimen={editingRegimen} open={isFormOpen} onOpenChange={setIsFormOpen} onSave={handleSave} />
    </div>
  )
}
    ...
    <Card className="hover:shadow-md transition-shadow">
      <CardHeader className="pb-3">
        <div className="flex items-start justify-between">
          <div>
            <CardTitle className="text-base">{regimen.medicationName}</CardTitle>
          ...
          <div className="flex items-center gap-1">
            ...
            <Badge variant={regimen.scheduleType === "FIXED" ? "default" : "secondary"} className="text-xs">
      ...
      <CardContent className="space-y-3">
        ...
        <div className="flex gap-2 pt-2">
          ...
          <Button variant="outline" size="sm" onClick={onArchive} className="gap-1 bg-transparent">
