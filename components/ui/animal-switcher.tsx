    ...
    <div className="flex gap-2 overflow-x-auto pb-2">
      <button
        ...
        className={cn(
          ...
          !selectedAnimal ? "bg-primary text-primary-foreground" : "bg-background hover:bg-accent",
        )}
      >
        All Animals
      ...
      {animals.map((animal) => (
        <button
          ...
          className={cn(
            "flex items-center gap-2 rounded-full border px-3 py-1.5 text-sm font-medium transition-colors whitespace-nowrap",
            selectedAnimal?.id === animal.id ? "bg-primary text-primary-foreground" : "bg-background hover:bg-accent",
          )}
        >
