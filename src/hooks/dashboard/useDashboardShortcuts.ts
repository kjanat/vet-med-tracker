...
} from "@/hooks/shared/useKeyboardShortcuts.ts";
...
export const useDashboardShortcuts = ({
  setFiltersAction,
  setShowKeyboardShortcutsAction,
  enabled = true,
}: {
  setFiltersAction: FiltersSetter;
  setShowKeyboardShortcutsAction: ToggleSetter;
  enabled?: boolean;
}) => {
  ...
  React.useEffect(() => {
    ...
    const shortcuts = createDashboardShortcuts({
      ...
      setShowKeyboardShortcuts: setShowKeyboardShortcutsAction,
    });
