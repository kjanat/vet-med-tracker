...
import { useHistoryFilters } from "@/hooks/history/useHistoryFilters.ts";
...
import { localDayISO } from "@/lib/utils/tz";
  ...
  const dailyCounts = useMemo(() => {
    ...
    monthRecords.forEach((record) => {
      ...
      if (!counts.has(dayKey)) {
        counts.set(dayKey, { late: 0, missed: 0, onTime: 0, prn: 0, total: 0 });
      }
