...
import { useDashboardShortcuts } from "@/hooks/dashboard/useDashboardShortcuts.ts";
import {
  computeNextActions,
...
export default function DashboardPage() {
  ...
  useDashboardShortcuts({
    ...
    setShowKeyboardShortcutsAction: setShowKeyboardShortcuts,
  });
  ...
  const todayStats = useMemo(() => {
    if (!todayAdmins || !dueRegimens) {
      return { completed: 0, compliance: 0, total: 0 };
    }
    ...
    return { completed, compliance, total };
