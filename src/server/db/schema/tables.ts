...
import { defaultUserPreferences, defaultUserProfile } from "./user-defaults.ts";
...
export const vetmedUsers = pgTable(
  "vetmed_users",
  {
    ...
    preferences: jsonb("preferences")
      ...
      .$defaultFn(() => structuredClone(defaultUserPreferences))
      .notNull(),
    profile: jsonb("profile")
      .$type<UserProfileSchema>()
      .$defaultFn(() => structuredClone(defaultUserProfile))
      .notNull(),
...
// =============================================================================
// TYPE EXPORTS - Public Schema API
// =============================================================================
// These type exports are intentional public API for the schema, providing
// convenient type aliases for database operations throughout the codebase.
// Use these instead of repeatedly typing `typeof table.$inferInsert/Select`
//
// Note: Warnings about unused exports are expected - these types are meant
// to be imported and used throughout the application as needed.
