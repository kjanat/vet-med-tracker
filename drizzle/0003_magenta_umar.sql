...
ALTER TABLE "vetmed_notifications"
    ADD CONSTRAINT "vetmed_notifications_user_id_vetmed_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."vetmed_users" ("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "vetmed_notifications"
    ADD CONSTRAINT "vetmed_notifications_household_id_vetmed_households_id_fk" FOREIGN KEY ("household_id") REFERENCES "public"."vetmed_households" ("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
