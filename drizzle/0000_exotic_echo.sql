...
ALTER TABLE "vetmed_inventory_items" ADD CONSTRAINT "vetmed_inventory_items_medication_id_vetmed_medication_catalog_id_fk" FOREIGN KEY ("medication_id") REFERENCES "public"."vetmed_medication_catalog"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "vetmed_administrations" ADD CONSTRAINT "vetmed_administrations_source_item_id_vetmed_inventory_items_id_fk" FOREIGN KEY ("source_item_id") REFERENCES "public"."vetmed_inventory_items"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "vetmed_regimens" ADD CONSTRAINT "vetmed_regimens_medication_id_vetmed_medication_catalog_id_fk" FOREIGN KEY ("medication_id") REFERENCES "public"."vetmed_medication_catalog"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
