...
import { vetmedUsers, vetmedAuditLog, vetmedHouseholds, vetmedNotificationQueue, vetmedMemberships, vetmedInventoryItems, vetmedAnimals, vetmedMedicationCatalog, vetmedRegimens, vetmedAdministrations } from "./schema";
